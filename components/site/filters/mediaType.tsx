...
export default function MediaTypeFilter() {
  ...
  const filter = filters[availableFilters.media_type.label];
  ...
  return (
    <div className="w-full flex-1">
      <select
        ...
        value={filter}
        onChange={(e) =>
          addFilter(availableFilters.media_type.label, e.target.value)
        }
      >
        {_.map(availableFilters.media_type.values, ({ label, value }) => (
