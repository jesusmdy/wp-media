...
export default function PerPageFilter() {
  ...
  const filter = filters[availableFilters.per_page.label];
  ...
  return (
    <div className="w-full flex-1">
      <select
        ...
        value={filter}
        onChange={(e) =>
          addFilter(availableFilters.per_page.label, e.target.value)
        }
      >
        {_.map(availableFilters.per_page.values, ({ label, value }) => (
